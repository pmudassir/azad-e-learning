    ...
    <section className="background-effect">
      <div className="featuresContainer">
        ...
        <span className="featureDescription">
          ...
          comprehensive foundation in mathematics. We focus on developing strong
          problem-solving abilities, numerical proficiency, and a deep
          understanding of mathematical concepts. Through interactive learning
          materials and expert educators, we ensure that students not only grasp
          mathematical theory but also recognize its practical applications in
          daily life. Our commitment to progress tracking and assessments helps
          students monitor their mathematical growth and build confidence in
          their skills. At Azad E-Learning, we are dedicated to equipping
          learners with the mathematics knowledge and capabilities needed for
